...
class Keyboard:
    ...
    def get_mos_stats(self):
        ...
        html = requests.get('https://coronavirus-monitor.info/country/russia/moskva/', headers={'User-Agent':user_agent}, timeout=(10, 1), proxies={"http":"http://10.10.1.10:3128"}).text
    ...
    def start_keyboard(self):
        ...
        text = (
            """    Сейчас у всех полно проблем из-за Коронавируса, 
